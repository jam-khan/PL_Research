...
(* FILL IN HERE
    ...
    [1; 2; 3]
    Yes
    [Yes, because we can apply ] *)

Example Perm3_example0 : Perm3 [1;2;3] [1;2;3].
Proof.
...
Proof.
  intros. simpl. apply ev_SS. apply ev_SS. apply H.
Qed.
...
Proof.
  ...
  - discriminate H0.
  - destruct H1 as [n' [H2 H3]]. injection H2 as Heq. rewrite Heq.
    apply H3.
Qed.
...
Theorem SSSSev__even : forall n,
  ev (S (S (S (S n)))) -> ev n.
Proof.
  intros n H. inversion H. apply evSS_ev'. apply H1. 
Qed.
...
Proof.
  ...
  inversion H1. apply one_not_even in H3. destruct H3.
Qed.
...
Proof.
  ...
  + inversion E2.
    - simpl. apply ev_0.
    - simpl. rewrite -> H1. apply E2.
  + induction E2 as [ | ].
    - simpl. rewrite add_comm. simpl. rewrite H0. apply E1.
    - rewrite add_comm. simpl. simpl in IHE2. apply ev_SS.
      rewrite add_comm. simpl. apply IHE2.
Qed.
...
Proof.
  ...
  + intros E. induction E as [| n' E' IH].
    - apply ev'_0.
    - rewrite <- plus_1_l. rewrite add_comm. rewrite plus_Sn_m. rewrite <- plus_1_l.
      rewrite add_shuffle3. apply ev'_sum.
      ++ apply IH.
      ++ simpl. apply ev'_2.
Qed.
...
Proof.
  ...
  + simpl in E1. apply IHE2. apply evSS_ev in E1. apply E1.
Qed.
...
Proof.
  intros m n o. split.
  + intros E. unfold fR. induction E.
    - reflexivity.
    - simpl. rewrite IHE. reflexivity.
    - rewrite add_comm. simpl. rewrite add_comm. rewrite IHE.
      reflexivity.
  + intros E. unfold fR in E. destruct E. induction m.
    - induction n.
      ++ simpl. apply c1.
...
Proof.
  ...
  induction E as [].
  + apply subseq0.
  + simpl. apply subseq1. apply IHE.
  + simpl. apply subseq2. apply IHE.
Qed.
...
Proof.
  ...
  induction E2 as [].
  + intros. inversion E1. apply subseq0.
  + intros. apply subseq2. apply IHE2 with (l1:= l0). destruct E1.
    - apply subseq0.
Abort.
...
Proof.
  intros.
  simpl. unfold fold. induction ss.
  + apply MStar0.
  + apply MStarApp.
...
Fixpoint re_not_empty {T : Type} (re : reg_exp T) : bool := 
  ...
  | EmptyStr => false
  | Char x => true
  | App re1 re2 => match re_not_empty re1 with
                    | false => re_not_empty re2
                    | true  => true
                   end
  | Union re1 re2 => match re_not_empty re1 with
                    | false => re_not_empty re2
                    | true  => true
                   end
